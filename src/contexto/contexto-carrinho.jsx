// 1. Criamos e exportamos o Contexto
import { createContext, useState, useEffect } from 'react';

// 1. Criamos e exportamos o Contexto
export const ContextoCarrinho = createContext(null);

const CHAVE_LOCAL_STORAGE = 'doces_lud_carrinho_v1'; /* isso é completamente provisorio so pra testarmos a plataforma em construção */

// 2. Criamos e exportamos o Provedor no MESMO arquivo
